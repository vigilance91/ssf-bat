...
if defined CLI_FLAGS (
    ...
    %php5% %VSN_SSF_CLI_PHP56_DIR%/run.php --M=encode --F=str --source="%SRC%" --privateKey=%PKP% --password=%PKPW% --base64 %CLI_FLAGS%
) else (
    %php5% %VSN_SSF_CLI_PHP56_DIR%/run.php --M=encode --F=str --source="%SRC%" --privateKey=%PKP% --password=%PKPW% --base64
)
